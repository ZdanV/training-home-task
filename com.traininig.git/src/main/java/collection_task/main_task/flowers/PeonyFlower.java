...
public class PeonyFlower extends Flower{
    private final String flowerName = "Peony";
    private final int flowerCost = 320;

    public PeonyFlower() {
    }

    public PeonyFlower(FlowerColors color, FlowerFreshness freshness, FlowerStemLength stemLength) {
