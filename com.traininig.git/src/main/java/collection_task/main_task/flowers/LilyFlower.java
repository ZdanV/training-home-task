...
public class LilyFlower extends Flower{
    private final String flowerName = "Lily";
    private final int flowerCost = 300;

    public LilyFlower() {
    }

    public LilyFlower(FlowerColors color, FlowerFreshness freshness, FlowerStemLength stemLength) {
